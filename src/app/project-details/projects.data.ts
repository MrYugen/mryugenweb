...
export interface Project {
  ...
  moodboardImgs: string[];
  moodboardText: string;
  bocetoDescription: string;
  bocetoImg: string;
  finalImg: string;
...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    duration: '2 semanas',
    briefDescription: 'En mayo de 2020, Selu Rizo, fotógrafo profesional freelance, confió en mi estudio para dar forma a su nueva imagen de marca.<br><br>El reto: <strong>crear desde cero un logotipo y unas tarjetas de visita</strong> que no solo transmitieran <em>profesionalidad</em>, sino que reflejaran su estilo visual único y la pasión que imprime en cada trabajo.',
  ...
  },
  {
    ...
    duration: '1 semana',
    briefDescription: 'En junio de 2021, Coral Cakes, una encantadora empresa británica especializada en cupcakes artesanales, me encargó el <strong>diseño de un logotipo que expresara su identidad creativa</strong>, alegre y memorable.<br><br>El reto era sencillo en apariencia, pero profundo en su ejecución: capturar en una sola imagen la dulzura, elegancia y originalidad que la marca ofrece.',

    moodboardImgs: [
      '/assets/images/coral_mood1.png',
      '/assets/images/coral_mood2.png'
    ],
    moodboardText: 'La fase inicial fue una exploración intensa y divertida: me sumergí en diversas paletas cromáticas cosy, tipografías amigables y modernas, y en tendencias de diseño actuales en el sector de la repostería creativa.<br><br><strong>El objetivo claro: encontrar la esencia visual que diferenciara a Coral Cakes</strong>, realzando su identidad creativa en un mercado saturado.',

    bocetoDescription: 'Con una paleta cromática cálida, dulce y atractiva definida, realicé múltiples bocetos y conceptos visuales. Cada propuesta buscaba transmitir alegría, cercanía y creatividad.<br><br>Junto a la clienta, evaluamos cada opción cuidadosamente, seleccionando finalmente un diseño que reflejaba plenamente su visión.',
    bocetoImg: '/assets/images/coral_boceto.jpg',
    finalImg: '/assets/images/coral_final.jpg',

    conclusionText: 'Una vez elegida la propuesta definitiva, desarrollé el logotipo final en <strong>Adobe Illustrator</strong>, asegurando un formato vectorial escalable y de calidad premium. El resultado fue un logotipo versátil, eficaz en cualquier contexto y en cualquier color de fondo, garantizando así una imagen consistente y profesional en todas las aplicaciones digitales e impresas.<br><br>Entregué todos los archivos finales junto a varios diseños de packaging para los productos, todos en formatos vectoriales de alta resolución, preparados para impresión profesional y uso digital inmediato.<br><br><strong><em>¿Quieres darle a tu marca una imagen memorable y deliciosa?</em></strong><br><br>Contáctame y juntos haremos realidad tu visión creativa.',
    mockups: [
  ...
  },
  {
    ...
    duration: '1 mes',
    briefDescription: 'En agosto de 2023, F.C. Beltatrez, un equipo de fútbol con raíces en Timor Oriental y sede en Oxford (Reino Unido), confió en mí para llevar a cabo un <strong>rebranding integral.</strong><br><br>El desafío era <strong>renovar la imagen del escudo oficial, diseñar una nueva equipación deportiva principal y rediseñar una bandera representativa,</strong> fusionando la cultura de Timor Oriental con una estética moderna y llamativa que potenciara la identidad única del club.',

    moodboardImgs: [
      '/assets/images/belta_mood1.jpg',
      '/assets/images/belta_mood2.jpg'
    ],
    moodboardText: 'Comencé profundizando en la historia visual del equipo, recopilando fotografías y gráficos previos, al mismo tiempo que obtenía información y feedback directamente del entrenador y el cuerpo técnico. Esto permitió definir claramente la dirección visual de la nueva equipación.<br><br>Teniendo en cuenta la identidad cultural de Timor Oriental, elaboré diversos bocetos y exploré múltiples conceptos visuales, probando elementos gráficos, colores vibrantes y tipografías modernas.',

    bocetoDescription: 'Después de varias revisiones junto al equipo, se seleccionó un diseño definitivo que reflejara perfectamente la esencia del club. La fase digital implicó transformar el diseño antiguo del logo en un escudo vectorial escalable, garantizando su adaptabilidad a diferentes formatos y usos y manteniendo la estética y elementos gráficos del anterior.<br><br>Con Procreate, realicé mockups detallados de la equipación, asegurando una visualización precisa y realista de los colores y patrones seleccionados. La bandera fue rediseñada con el nuevo logotipo, usando principalmente los colores rojo y negro emblemáticos de Timor Oriental.',
    bocetoImg: '/assets/images/belta_boceto.jpg',
    finalImg: '/assets/images/belta_final.jpg',

    conclusionText: 'Entregué al club todos los archivos finales, listos para aplicaciones físicas y digitales. Además, proporcioné asesoramiento especializado sobre materiales, medidas, proveedores y tiempos de producción, facilitando así la adquisición eficiente de equipaciones y merchandising oficial de alta calidad.<br><br><strong>¿Quieres modernizar la imagen de tu equipo y destacar sobre el terreno de juego?</strong><br><br>Contáctame y hagamos realidad la visión deportiva de tu club.',
    mockups: [
  ...
  },
  {
    ...
    moodboardText: 'Inicié el proyecto sumergiéndome en el universo emocional y delicado de los muñecos reborn. Realicé un análisis detallado de los productos, exploré valores clave que la empresa quería proyectar y estudié la competencia para asegurar que el diseño final destacara claramente la identidad única y personal de <strong>Amor y Arte</strong>.<br><br>Tras una conversación profunda con el cliente, definí una paleta cromática suave y elegante, alineada con la esencia del proyecto. Planteé varias propuestas iniciales, utilizando trazos cálidos y tipografías cercanas que reflejaran la emotividad y delicadeza que caracteriza a los muñecos reborn.',

    // → Datos de sección 3 (before/after)
    bocetoDescription: 'El cliente seleccionó rápidamente la propuesta que mejor conectaba con su visión. Una vez elegidos los elementos visuales y tipográficos, desarrollé la versión final del logotipo en formato vectorial.<br><br>Ajusté cuidadosamente medidas, colores y distribución tipográfica para asegurar que el resultado transmitiera equilibrio visual y reflejara la esencia cálida y tierna de Amor y Arte.',
    bocetoImg: '/assets/images/amor_boceto.jpg',
    finalImg: '/assets/images/amor_final.jpg',

    // → Datos de sección 4 (mockups y conclusiones)
    conclusionText: 'Proporcioné los archivos digitales finales en alta resolución, preparados para ser usados inmediatamente en diversos soportes digitales e impresos. Además, creé mockups realistas del logotipo aplicado a packaging existente, mostrando cómo la nueva identidad visual mejoraría la experiencia del cliente.<br><br><strong><em>¿Quieres una identidad visual que refleje con elegancia y autenticidad la esencia de tu negocio artesanal?</em></strong><br><br> Contáctame y llevemos tu marca al siguiente nivel.',
    mockups: [
  ...
  },
  {
    ...
    tools: [ { name: 'Photoshop', icon: 'assets/images/icons/Adobe_Photoshop_CC_icon.svg' },
            { name: 'Illustrator', icon: 'assets/images/icons/Adobe_Illustrator_CC_icon.svg' } ],
    duration: '1 mes',
    briefDescription: 'En junio de 2022, Swamp Labs confió en mí para llevar a cabo el <strong>diseño integral de su colección NFT en la blockchain de Solana.</strong><br><br> El reto: <em>fusionar el universo del arte procedural con un rebranding completo y la creación de un ecosistema visual coherente y memorable.</em> El encargo abarcó desde el <strong>diseño de personajes exclusivos</strong>, pasando por <strong>ilustraciones vectoriales</strong> únicas, hasta el desarrollo de un <strong>nuevo logotipo y banner</strong> destinado a posicionar la marca en redes sociales y la web.',
  ...
  },
  {
    ...
    tools: [ { name: 'Photoshop', icon: 'assets/images/icons/Adobe_Photoshop_CC_icon.svg' },
      { name: 'Illustrator', icon: 'assets/images/icons/Adobe_Illustrator_CC_icon.svg' }, ],
    duration: '1 semana',
    briefDescription: 'En octubre de 2024 nace Ikigai Games, la futura editorial de juegos de mesa creada para convertirse en un referente de creatividad, pasión y diversión en el sector.<br><br>El primer desafío fue elegir un nombre que resumiera la filosofía y el propósito de la marca: Ikigai, el término japonés que representa la <em>“razón de vivir”</em>, fusionando pasión, vocación, misión y profesión en una sola palabra.<br><br><strong>La meta:</strong> crear un logotipo que encarne esa energía, prepare el terreno para los futuros lanzamientos —empezando por el esperado Couple Clash— y transmita a simple vista el alma de la editorial.',
    ...
    moodboardText: 'El punto de partida fue la búsqueda del nombre perfecto. Analicé tendencias, valores y nombres del sector, pero ningún término tenía el peso, la profundidad y el simbolismo de <em>“Ikigai”</em>. Este concepto conecta con quienes creen que <strong>los juegos de mesa son mucho más que ocio</strong>: <em>son una experiencia compartida que da sentido, une y crea recuerdos inolvidables.</em><br><br> Definido el nombre, exploré distintas paletas cromáticas y referencias visuales para dotar a la marca de una identidad vibrante, contemporánea y única.',

    // → Datos de sección 3 (before/after)
    bocetoDescription: 'Con los elementos elegidos, creé el logotipo definitivo en formato vectorial. El resultado: una imagen versátil, llena de color y dinamismo, preparada para acompañar cada lanzamiento y transmitir el propósito vital de la editorial.<br><br>El símbolo infinito y los degradados cromáticos evocan la creatividad, la diversidad y la energía que Ikigai Games quiere aportar al mundo de los juegos de mesa.',
    bocetoImg: '/assets/images/ikigai_boceto.jpg',
    finalImg: '/assets/images/ikigai_final.jpg',

    // → Datos de sección 4 (mockups y conclusiones)
    conclusionText: 'El logotipo de Ikigai Games ya está listo para lucirse en la primera gran aventura editorial: <strong>Couple Clash</strong>. Todo está preparado para que la marca despegue y se posicione como un nuevo referente de originalidad, profesionalidad y pasión en el sector lúdico.<br><br><strong>¿Quieres que tu editorial destaque con una imagen que transmita propósito, pasión y creatividad?</strong><br><br>Contáctame y da vida a tu proyecto de juegos con una identidad visual única.',
    mockups: [
  ...
  },
  {
    ...
    tools: [ { name: 'Photoshop', icon: 'assets/images/icons/Adobe_Photoshop_CC_icon.svg' },
      { name: 'Illustrator', icon: 'assets/images/icons/Adobe_Illustrator_CC_icon.svg' }, ],
    duration: '1 semana',
    briefDescription: 'En julio de 2023, emprendí uno de los retos más personales e ilusionantes de mi carrera: <strong>renovar la imagen gráfica de mi propia marca, Mr. Yugen</strong>. Este rebranding no solo es un cambio visual, sino el reflejo de una transformación interna —un viaje hacia la autenticidad, la creatividad y la belleza profunda inspirada en el concepto japonés de <em>“Yūgen”.</em>',
  ...
  },
  {
    ...
    ctaText: 'Lleva tu proyecto al siguiente nivel',
    overlayOpacity: 0.10,
    showTitle: false,            
    showCTA: false,              
    logoSize: 'w-[350px] max-w-full md:w-[500px]',
  ...
  },
  {
    ...
    ctaText: 'Renueva la imagen de tu asesoría',
    overlayOpacity: 0.10,
    showTitle: false,            
    showCTA: false,              
  ...
  },
  {
    ...
    tools: [ { name: 'Photoshop', icon: 'assets/images/icons/Adobe_Photoshop_CC_icon.svg' },
      { name: 'Illustrator', icon: 'assets/images/icons/Adobe_Illustrator_CC_icon.svg' }, ],
    duration: '2 meses',
    briefDescription: 'En febrero de 2018, Caffeine Studios, un joven pero ambicioso estudio creativo especializado en el desarrollo de aplicaciones web y videojuegos, se embarcó en el reto de actualizar su identidad visual y toda su presencia gráfica online y offline.<br><br>Mi labor fue profunda: desde la <strong>reinvención del logotipo</strong> hasta la <strong>creación de una nueva tarjeta de visita</strong>, el <strong>diseño de iconos vectoriales</strong> inspirados en la molécula de cafeína y la producción de <strong>ilustraciones personalizadas</strong> que representasen la esencia, valores y personalidad del equipo.',
  ...
  },
  {
    ...
    ctaText: 'Te ayudo a crear un juego de mesa único',
    overlayOpacity: 0.10,
    showTitle: false,            
    showCTA: false,              
    logoSize: 'w-[200px] max-w-full md:w-[350px]',
    ...
    briefDescription: 'Couple Clash no es solo un juego de mesa. Es el resultado de cinco años de pasión, creatividad y dedicación obsesiva: un proyecto personal donde convergen mi amor por la estrategia, las ilustraciones, el humor y las partidas inolvidables.<br><br>Mi reto era <strong>crear el juego al que siempre quise jugar</strong>: partidas rápidas y adictivas, reglas sencillas pero difíciles de dominar, componentes irresistibles y una experiencia que engancha tanto a parejas como a grupos de amigos.<br><br>Hoy, Couple Clash está a punto de llegar a imprenta. Detrás hay un proceso artesanal —de ensayo, error y mucho aprendizaje—, decenas de versiones y un universo visual coherente y vibrante que invita a cualquier jugador a sumergirse en el <em>“arte de discutir”</em> de la forma más divertida posible.',
  ...
  },
  {
    ...
    logoDark: '/assets/images/logo-hero-dark.svg',
    ctaText: '¿Quieres una invitación única?',
    overlayOpacity: 0.15,
    showTitle: false,            
    showCTA: false,              
    ...
    moodboardText: 'El primer paso fue conversar con la pareja y descubrir sus gustos, historias y referencias. Ambos compartían una pasión por la literatura fantástica y los mundos medievales —de Tolkien a George R.R. Martin—, así que decidí fusionar esos universos en el diseño. Me inspiré en la caligrafía gótica, los sellos de cera y las ilustraciones de cuentos antiguos, apostando por un formato premium, elegante y atemporal.<br><br>La idea clave surgió al analizar sus fotografías: <strong>¿y si sus perfiles se convirtieran en portales a un mundo de fantasía, integrando paisajes y personajes mágicos en el interior de cada silueta?</strong>',

    // → Datos de sección 3 (before/after)
    bocetoDescription: 'El formato elegido fue un <strong>díptico con dos solapas laterales</strong>, que al abrirse desde el centro desvelan el corazón del mensaje. En las solapas, trabajé la silueta de la pareja, esculpiendo sus perfiles con precisión artística y rellenándolos con una ilustración fantástica: montañas, castillos, magos, bosques y criaturas míticas se funden para narrar una historia visual.<br><br>Al unir las solapas por la parte trasera, las siluetas encajan en un beso sutil, completando al mismo tiempo la imagen de fondo y reforzando la idea de unión y destino compartido.<br><br>Cada boceto se revisó minuciosamente, ajustando tanto los rasgos faciales como el encuadre del arte interior, para lograr un efecto sorprendente tanto cerrado como desplegado. El interior de la invitación mantiene la línea dorada y el fondo azul oscuro ornamentado, enmarcando el texto con tipografías medievales y detalles decorativos inspirados en manuscritos antiguos. Todo el mensaje se redactó en clave de fantasía, invitando a los asistentes a vivir una noche de magia, misterios y celebración.',
    bocetoImg: '/assets/images/invitacion_boceto.jpg',
    finalImg: '/assets/images/invitacion_final.jpg',

    // → Datos de sección 4 (mockups y conclusiones)
    conclusionText: 'Aprobados los conceptos, realicé toda la composición en Adobe Illustrator, asegurando máxima nitidez y escalabilidad para la impresión. Probé distintas gamas cromáticas y acabados ornamentales, hasta dar con la combinación perfecta de dorados, azules profundos y detalles rojizos en el lacre. El diseño final incluía archivos independientes para cada parte de la invitación, preparados para una impresión profesional de alta calidad en formato CMYK. Para reforzar la experiencia, el sobre fue diseñado en un elegante tono púrpura y sellado con lacre personalizado, aportando un toque exclusivo y ceremonial al conjunto.<br><br>El resultado fue una invitación de boda digna de un cuento de fantasía: elegante, llena de detalles y cargada de significado personal. La pareja recibió una papelería que no solo anuncia su enlace, sino que invita a los asistentes a adentrarse en su propia leyenda, anticipando una velada inolvidable y mágica.<br><br><strong>¿Quieres una invitación de boda o papelería personalizada que cuente vuestra historia y sorprenda a todos los invitados?</strong><br><br>Contáctame y diseñemos juntos una pieza única que haga de vuestro día un recuerdo inolvidable.',
    mockups: [
...
},
{
    ...
    ctaText: 'Crea un logotipo auténtico y con carácter local',
    overlayOpacity: 0.05,
    showTitle: false,            
    showCTA: false,              
    logoSize: 'w-[200px] max-w-full md:w-[350px]',
    ...
    tools: [ { name: 'Illustrator', icon: 'assets/images/icons/Adobe_Illustrator_CC_icon.svg' }, ],
    duration: '3 días',
    briefDescription: 'En septiembre de 2022, tuve el privilegio de diseñar el logotipo de The Folly Inn, una taberna inglesa con carácter, situada en la pintoresca localidad de Faringdon, Oxfordshire.<br><br>El encargo consistía en <strong>crear una imagen de marca sencilla, elegante y memorable</strong>, que rindiera homenaje a la icónica Folly Tower —el monumento más representativo de la zona— y pudiera usarse tanto en cartelería como en merchandising o sellos oficiales del local.',
